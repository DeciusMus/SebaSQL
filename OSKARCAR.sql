...
(SPECIALCODE varchar(450) PRIMARY KEY, CarModel Varchar(450), TotalPrice Money, WarehouseID INT) 
...
AFTER DELETE
AS
INSERT INTO SOLDCARS SELECT SPECIALCODE, CarModel, TotalPrice, WarehouseID FROM DELETED
